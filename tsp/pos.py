...
class SwarmNetwork:
    def __init__(self, p_count, n_cities, scale, anealing_degree, lrp, lrg, momentum):
        ...
        self.particles = [
                ParticleLayer(self.cities, Momentum(3e-1, .999, momentum), temperature
    ...
    def _backprop(self):
        ...
        for i, p in enumerate(self.particles):
            ...
            leader = random.randint(0, 0 if i < ELITE else ELITE)#i // 4)#random.randint(0, ELITE)#
...
swarm = SwarmNetwork(10, 24, 1000, 9, lrp=1, lrg=1.5, momentum=.6)
